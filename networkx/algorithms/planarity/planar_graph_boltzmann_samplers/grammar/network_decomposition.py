...
from .grammar_utils import Counter

from ..bijections.networks import merge_networks_in_parallel, merge_networks_in_series, \
    substitute_edge_by_network
from ..combinatorial_classes.halfedge import HalfEdge
from ..combinatorial_classes.network import Network
from ..grammar.three_connected_decomposition import three_connected_graph_grammar
